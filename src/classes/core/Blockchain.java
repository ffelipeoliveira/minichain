...
public class Blockchain {
	...
	public void addTransaction(PublicKey senderPublicKey, PublicKey receiverPublicKey, float tokenAmount, String signature, Boolean isFee) {
		Transaction newTransaction = new Transaction(this.transactionHead, senderPublicKey, receiverPublicKey, tokenAmount, signature, isFee);
