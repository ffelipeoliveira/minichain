...
public class Transferring {
    ...
    public static Transaction userCreateTransaction(String menuPath, String defaultKeyDirectory, Blockchain blockChain)
            throws Exception {
        ...
        senderPublicKey = KeyManaging.userSelectPublicKey(menuPath, defaultKeyDirectory, false,
                "Select the sender's public key");
        if (senderPublicKey == null) {
            throw new Exception("Operation aborted");
        }

        Simple.banner(menuPath + " [2/5]");
        receiverPublicKey = KeyManaging.userSelectPublicKey(menuPath, defaultKeyDirectory, false,
        ...
        senderPrivateKey = KeyManaging.userSelectPrivateKey(menuPath, defaultKeyDirectory, false,
                "Select the sender's private key");
        if (senderPrivateKey == null) {
            throw new Exception("Operation aborted");
        }

        String data = ("(" + (amount - amount / 100) + ") " + senderPublicKey.hashCode() + "=>"
